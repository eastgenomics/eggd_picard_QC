...
- **run_CollectMultipleMetrics (default=true)**
  - Specifically, run CollectAlignmentSummaryMetrics, CollectInsertSizeMetrics, QualityScoreDistribution, MeanQualityByCycle, CollectBaseDistributionByCycle, CollectGcBiasMetrics, CollectQualityYieldMetrics.
  - See [CollectMultipleMetrics documentation](https://gatk.broadinstitute.org/hc/en-us/articles/360037594031-CollectMultipleMetrics-Picard-)
- **run_CollectHsMetrics (default=true)**
  - Collects hybrid-selection (HS) metrics for a SAM or BAM file.
  - See [CollectHsMetrics documentation](https://gatk.broadinstitute.org/hc/en-us/articles/360037591891-CollectHsMetrics-Picard-)
- **run_CollectTargetedPcrMetrics (default=false)**
  - Calculate PCR-related metrics from targeted sequencing data.
  - See [CollectTargetedPcrMetrics documentation](https://gatk.broadinstitute.org/hc/en-us/articles/360037225812-CollectTargetedPcrMetrics-Picard-)
...
- **run_CollectVariantCallingMetrics (default=false)**
  ...
  - See [CollectVariantCallingMetrics documentation](https://gatk.broadinstitute.org/hc/en-us/articles/360037057132-CollectVariantCallingMetrics-Picard)
...
> [!WARNING]
> The dbSNP file must be generated using the same sequence dictionary used in the reference genome
